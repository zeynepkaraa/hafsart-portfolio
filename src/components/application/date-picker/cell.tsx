        ...
        return (
          <div
            className={cx(
              ...
              markedAsSelected &&
                "bg-custom font-medium text-white hover:bg-custom hover:text-white",
              // Hover state for non-selected cells.
              !isSelected && !isDisabled ? "hover hover:font-medium!" : "",
              !isSelected && isTodayDate
                ? "bg-secondary font-medium hover:bg-secondary_hover"
                : "",
            )}
          >
            {formattedDate}
            ...
            {(isHighlighted || isTodayDate) && (
              <div
                className={cx(
                  ...
                  markedAsSelected ? "bg-fg-white" : "bg-fg-custom",
