...
export const FileUploadDropZone = ({
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={cx(
        "relative flex flex-col items-center gap-3 rounded-xl bg-primary px-6 py-4 text-tertiary ring-1 ring-customborder transition duration-100 ease-linear ring-inset",
      ...
      <div className="flex flex-col gap-1 text-center">
        <div className="flex justify-center gap-1 text-center">
          ...
          <label htmlFor={id} className="flex cursor-pointer items-center">
            ...
            <span className="text-sm max-md:hidden text-tertiary font-light pl-1">
              or drag and drop
            </span>
          </label>
        </div>
...
export const FileListItemProgressBar = ({
  ...
  return (
    <motion.li
      layout="position"
      className={cx(
        "relative flex gap-3 rounded-xl bg-primary p-4 ring-1 ring-customborder transition-shadow duration-100 ease-linear ring-inset",
...
export const FileListItemProgressFill = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cx(
          "absolute inset-0 size-full rounded-[inherit] ring-1 ring-customborder transition duration-100 ease-linear ring-inset",
          failed && "ring-2 ring-error",
        )}
      />
      <FileTypeIcon
