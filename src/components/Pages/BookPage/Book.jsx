        ...
        <div className={styles.block}>
          <div className={styles.content}>
            ...
            <p className="description">
              ...
              their outfits and energy in elegant, hand-drawn fashion portraits.
              It’s a creative and personal gift for your guests, making your
        ...
        <div className={styles.addOns}>
          <div className={styles.addOn}>
            ...
            <p className={styles.addOnDescription}>
              ...
              illustration feel even more special. Customization options include
              logos, initials, names, and dates.
            </p>
          </div>
          <div className={styles.addOn}>
