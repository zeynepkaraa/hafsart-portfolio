        ...
        <div className={styles.block}>
          ...
          <div className={styles.content}>
            ...
            <p className="description" style={{ marginTop: "5%" }}>
              Hand-drawn custom illustrations created from your favorite photos.
              Whether you're celebrating a milestone or preserving a special
              memory, your artwork is made to be a timeless keepsake you'll
              cherish forever.
            </p>
            <button
